...
public class PetersonTree {
	...
	public void PTlock() {
		...
		// Keep trying to obtain the next level lock until you've achieved root
		// lock
		while (start >= 0) {
			me = i;
	...
	public void PTunlock() {
		int i = THREAD_ID.get();
		ArrayList<Integer> path = new ArrayList<Integer>(this.MAX_DEPTH + 1);
		int start = 0;
		path.add(i);
